 ...
 *
 * Prerequisites:
 *   - The external connection (nasaApodConnector) must already exist with a provisioned schema.
 *   - Azure AD app with ExternalItem.ReadWrite.All (application) permission.
 *   - NASA_API_KEY set in .env (or DEMO_KEY is used by default).
 */
